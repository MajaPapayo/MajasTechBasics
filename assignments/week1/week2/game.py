def game():   
 #imports
    ...
    #story introduction
    typingPrint("You have woken up in a little hut in the middle of a forest. Before you leave the house you remember the dangers of the world outside so you decide to take a weapon with you.\n")
    ...
    def fighting():
        ...
        while enemy_health>0:
            if weapon_hand == "sword":
                ...
                hit=random.randint(0,101)
                if hit<=20 and weapon_hand=="wand":
                    typingPrint("Your spell barley influenced"+ enemy_name +".")
                elif hit>=70 and weapon_hand=="wand":
                    typingPrint("Your spell was magnificent"+ enemy_name +"'s weak spot was hit. ")
                elif 20<=hit<=70 and weapon_hand=="wand":
                    typingPrint("Your spell on"+ enemy_name +"successfully hit them")

                enemy_health-=hit
                typingPrint("You dealt "+ str(hit) +" damage. Enemy health is now at "+ str(enemy_health) + ". \n" )
                time.sleep(1)
        else:
            typingPrint("You have successfully defeated"+ enemy_name + ".")
            game_ending1()
    #
    def try_choice():
                    try:
    ...
    def try_choice2():
                    try:
                        try_again= int(typingInput("\nDo you want to\n[1] go home.\n[2] try fighting the unicorn.\n[3] try approaching the unicorn again.\nPlease enter 1,2 or 3:"))
                        if try_again==1:
                                typingPrint("You go back to the hut put down your " +weapon_hand+ " and call it quits for today. \n" )
                                game_ending2()
                        elif try_again==2:
                                typingPrint("You turn around back through the forest and attack the unicorn.")
                                fighting()
                        elif try_again==3:
                                typingPrint("You carefully approach the unicorn, but step on a twig. The unicorn, startled by the sound, runs away. ")
                                game_ending3()
    ...
    #define endings
    def game_ending1():
        typingPrint("\nAfter defeating"+enemy_name+ "you return home, exhausted from your long day. \nThank you "+name+" for playing my game. Do you want to play again?\n")
        try:
    ...
    def game_ending2():
        typingPrint("\nAfter returning home, frightened from your experiences you lay down on your bed to rest. \nThank you "+name+" for playing my game. Do you want to play again?\n")
        try:
            end_choice= int(typingInput("[1] Yes! \n[2] No!\n"))
            if end_choice==1:
                game()
                ...
                typingPrint("Please only enter numbers. You have the choice between 1 or 2. \n"), game_ending2()
    def game_ending3():
        typingPrint("\nAfter failing to come closer to the unicorn, you return home disappointed from your day. \nThank you "+name+" for playing my game. Do you want to play again? \n ")
        try:
            end_choice= int(typingInput("[1] Yes! \n [2] No!\n"))
            if end_choice==1:
                game()
                ...
                typingPrint("Please only enter numbers. You have the choice between 1 or 2. \n"), game_ending3()
    def game_ending4():
        typingPrint("\nAfter spending some time with the unicorn, it befriends you. What a blissful day! \nThank you "+name+" for playing my game. Do you want to play again? \n ")
        try:
            end_choice= int(typingInput("[1] Yes! \n [2] No!\n"))
            if end_choice==1:
                game()
    ...
    #second decision where to go
    typingPrint("With your "+ weapon_hand +" in hand you leave the hut. Ready for adventure you follow the only way leading away from your hut. After a little while the way splits into two.")
    def way_choice():
        global enemy_name
        global enemy_health
